export const ar = {
  ...
  favoritesEmpty: "لا صالونات مفضلة بعد",
  favoritesEmptyHint: "اضغط ❤️ على أي صالون لإضافته",
  browseSalons: "تصفح الصالونات",
  filterAll: "الكل",
  filterMen: "حلاقة رجالي",
  filterWomen: "صالون نسائي",
  filterNearMe: "قريب مني",
  filterAvailable: "متاح الآن",
  addedToFavorites: "تمت الإضافة للمفضلة ❤️",
  removedFromFavorites: "تمت الإزالة من المفضلة",
  freeChairs: (n: number) => `${n} كرسي متاح`,
  noFreeChairs: "لا كراسي متاحة",
  isLive: "🟢 مباشر",
  bookNow: "احجز الآن",
  viewMap: "على الخريطة",
  removeFav: "إزالة",
  salonSearchPlaceholder: "ابحث بالاسم أو المدينة...",
  salonsNearby: "الصالونات القريبة",
  noSalons: "لا صالونات بعد",
  rating: "التقييم",
};
...
export const en = {
  ...
  favoritesEmpty: "No favorite salons yet",
  favoritesEmptyHint: "Tap ❤️ on any salon to add it",
  ...
  freeChairs: (n: number) => `${n} chair${n === 1 ? "" : "s"} free`,
  noFreeChairs: "No chairs available",
  isLive: "🟢 LIVE",
  bookNow: "Book Now",
  viewMap: "Map",
  removeFav: "Remove",
  salonSearchPlaceholder: "Search by name or city...",
  salonsNearby: "Salons Near You",
